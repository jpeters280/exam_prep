...
class Users(Controller):
    ...
    def index(self, id):
        ...
        """
        name = self.models['UserModel'].showname(id)
        poster = self.models['UserModel'].showquote(id)
        print poster
        count = self.models['UserModel'].countquote(id)
        return self.load_view('posts.html', name=name[0], poster=poster ,count=count[0])
